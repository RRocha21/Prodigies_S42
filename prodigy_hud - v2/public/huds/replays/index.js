...
// var t_color = "191, 13, 23";
var ct_color = "0, 199, 209";
// var ct_color = "0, 170, 179";
...
function fillPlayer(player, nr, side, max) {
    ...
    if (side == "right") {
        if (team == "ct") {
            ...
            $(".right_series").find(".block").css("border-color", "rgba(" + ct_color + " ,1)");
            ...
            $(".right_series").find(".block").css("border-color", "rgba(" + t_color + ",1)");
    ...
    if (side == "left") {
        if (team == "ct") {
            ...
            $(".left_series").find(".block").css("border-color", "rgba(" + ct_color + " ,1)");
            ...
            health_color = "linear-gradient(90deg, rgba(" + t_color + ", 0.3) 0px, rgba(" + t_color + ", 0.9) 143px, rgba(" + t_color + ", 1) 330px)";
            $(".left_series").find(".block").css("border-color", "rgba(" + t_color + ",1)");
